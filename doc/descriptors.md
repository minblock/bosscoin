# Support for Output Descriptors in Bosscoins Core

Since Bosscoins Core v0.17, there is support for Output Descriptors. This is a
...
on Bosscoins's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Bosscoins Core wallets, a convenience function `combo` is
