...
#if defined(NDEBUG)
# error "Bosscoins cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Bosscoins Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache, bool test_accept) EXCLUSIVE_LOCKS_REQUIRED(cs_main)
{
...

    {
        ...
        for (CTxMemPool::txiter it : allConflicting)
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s ARM additional fees, %d delta bytes\n",
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    if (nHeight == 1) return COIN * 1337338;
...
void ThreadScriptCheck() {
    RenameThread("bosscoins-scriptch");
