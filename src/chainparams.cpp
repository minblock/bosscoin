...
{
    const char* pszTimestamp = "4/2/2020 Provigen Networks: Now accepting finiteoshis!";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1586087875, 1418959, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x4ea44b7fbcbdbbc68875611f1ddc2c6abc2bcff6d5fb54e3ebca4393bb269df2"));
        assert(genesis.hashMerkleRoot == uint256S("0x5b556271b43fa576d54237fb80602b9bc3f8fa3d7fae9dd1425e060312b934d0"));
        ...
        vSeeds.emplace_back("seed-a.bosscoins.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.bosscoinstools.com");
        vSeeds.emplace_back("dnsseed.bosscoinspool.org");
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 215706, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x31dfd7c05ff451a3a563758f2ae6df3d4576de59577819e3110891b0b5da446f"));
        assert(genesis.hashMerkleRoot == uint256S("0x5b556271b43fa576d54237fb80602b9bc3f8fa3d7fae9dd1425e060312b934d0"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-seed.bosscoinstools.com");
        vSeeds.emplace_back("seed-b.bosscoins.loshan.co.uk");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0a2ee1267fcb1aa77aa4f51085cb49b38790aaf4f1ebba640c3d855a2bea49f3"));
        assert(genesis.hashMerkleRoot == uint256S("0x5b556271b43fa576d54237fb80602b9bc3f8fa3d7fae9dd1425e060312b934d0"));
