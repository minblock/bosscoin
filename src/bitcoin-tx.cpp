...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " bosscoins-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  bosscoins-tx [options] <hex-tx> [commands]  Update hex-encoded bosscoins transaction\n" +
            "or:     bosscoins-tx [options] -create [commands]   Create hex-encoded bosscoins transaction\n" +
            "\n";
