...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Bosscoins Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Bosscoins Core"
...
#define PACKAGE_BUGREPORT "https://github.com/bosscoins-project/bosscoins/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Bosscoins Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Bosscoins Core 0.18.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bosscoins"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://bosscoins.org/"
