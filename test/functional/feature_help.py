...
"""Verify that starting bosscoins with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bosscoins with -h for help text")
        ...
        self.log.info("Start bosscoins with -version for version information")
        ...
        self.log.info("Start bosscoinsd with -fakearg to make sure it does not start")
