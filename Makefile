...
pkgdatadir = $(datadir)/bosscoins
pkgincludedir = $(includedir)/bosscoins
pkglibdir = $(libdir)/bosscoins
pkglibexecdir = $(libexecdir)/bosscoins
...
ACLOCAL = ${SHELL} /bosscoins/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /bosscoins/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /bosscoins/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /bosscoins/build-aux/missing automake-1.15
AVX2_CXXFLAGS = -mavx -mavx2
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = bosscoins-cli
BITCOIN_DAEMON_NAME = bosscoinsd
BITCOIN_GUI_NAME = bosscoins-qt
BITCOIN_TX_NAME = bosscoins-tx
BITCOIN_WALLET_TOOL_NAME = bosscoins-wallet
...
COPYRIGHT_HOLDERS_FINAL = The Bosscoins Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = Bosscoins Core
COPYRIGHT_YEAR = 2019
CPP = gcc -E
...
MAINT = 
MAKEINFO = ${SHELL} /bosscoins/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = bosscoins
PACKAGE_BUGREPORT = https://github.com/bosscoins-project/bosscoins/issues
PACKAGE_NAME = Bosscoins Core
PACKAGE_STRING = Bosscoins Core 0.18.1
PACKAGE_TARNAME = bosscoins
PACKAGE_URL = https://bosscoins.org/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /bosscoins
abs_srcdir = /bosscoins
abs_top_builddir = /bosscoins
abs_top_srcdir = /bosscoins
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /bosscoins/build-aux/install-sh
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/Bosscoins-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/MacOS/Bosscoins-Qt: all-recursive
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Bosscoins-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Bosscoins-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
